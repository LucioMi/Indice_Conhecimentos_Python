...
cursor.execute("drop table 'nome da tabela' ")   #apaga de vez da memoria tanto tabelas quanto o proprio bd dependendo a sintaxe
"""=============================================================================================================================================================
                                                                      FUNCÕES DE SELEÇÃO
============================================================================================================================================================="""
#SELECT `M_Aparente` FROM `db_prensa_software`.`grafico`
